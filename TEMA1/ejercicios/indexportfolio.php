...
<body>
  <div class="container">
    <div id="resume-header" class="row">
      ...
      <div class="col">
        <h1><?php echo "José Aguilera" ?></h1>
        <h2><?php echo "DWES" ?></h2>
        <ul>
          <li>Mail: Incluye email</li>
          <li>Phone: Incluye teléfono</li>
          <li>LinkedIn: Incluye linkedin</li>
    ...
    <div class="row">
      <div class="col">
        <div>
          ...
          <?php
           foreach($aExperienciaLaboral as $array => $value){
            echo "<br>";

            foreach($value as $experiencia => $informacion){
              echo "<b>".$experiencia .": </b>" . $informacion . " <br>";
